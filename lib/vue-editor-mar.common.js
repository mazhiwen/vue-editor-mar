...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports["default"] = void 0; // 获取数组的并集
...
var deepDiff = function () {
  function a(c, d) {
    ...
    var e = _util["default"].unionArray(Object.keys(c), Object.keys(d)),
        f = !0,
        g = !1,
        h = void 0;
...
// EXTERNAL MODULE: ./node_modules/utility-mar/lib/util.js
...
var lokijs = __webpack_require__(4);
  ...
  if (wordType) {
    ...
    wordTypesListT.forEach(function (value, index) {
      if (wordTypeKeyList.includes(value.type)) {
        value.words = util_default.a.unionArray(value.words, wordType[value.type]);
      }
    });
  }
